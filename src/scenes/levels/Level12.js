...
class Level11 extends Phaser.Scene {
    ...
    create() {
        ...
        // Map
        const map = this.make.tilemap({ key: 'level12' });
        ...
        const wallLayer = map.createLayer('wall', terrainTileset, 0, 0);
        floorLayer.setScale(2);
        bushLayer.setScale(2);
        wallLayer.setScale(2);
        ...
        this.physics.add.collider(this.bullets, wallLayer, this.collisionHandlers.checkBulletCollidesWalls, null, this);
